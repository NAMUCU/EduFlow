...
import { StudentStats, RecentActivity, WeakUnit } from '@/types/student';
...
export const OverviewTab = memo(function OverviewTab({ stats, recentActivities, weakUnits }: OverviewTabProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <StatCard
          ...
          subtitle={<div className="flex items-center gap-1"><TrendIcon trend={stats.trend} /> 지난달 대비</div>}
          icon={<Target className="w-5 h-5" />}
          color="blue"
        />
        <StatCard
          title="완료 과제"
          value={`${stats.completedAssignments}개`}
          subtitle={`총 ${stats.totalAssignments}개 중`}
